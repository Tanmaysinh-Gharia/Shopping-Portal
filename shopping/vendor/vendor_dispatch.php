...
function disp_apr($con)
{
    ...
    $qry_sel_order_id = "SELECT oi.order_id, i.name, i.price, oi.qty, i.id, o.sm_id, o.order_date, 
                            ...
                            WHERE oi.status = 2 and i.vend_id = $vend_id;";
    ...
    while ($row = mysqli_fetch_assoc($res) ) {
        ...
        echo "<td>
                <button style='padding:20px;font-size:20px;' type='submit' class='btn btn-success' name='btn' value='$approval_id' >Dispatch</button>
            </td>";
        echo "</tr>";
        $i++;
...
<body>
    <form style="width: 100%;" method='post' action='vendor_dispatch_action.php'>
    <div class="container">
        <h3>
            Dispatch of Orders...
        </h3>
