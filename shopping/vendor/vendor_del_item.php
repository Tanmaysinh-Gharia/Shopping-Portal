...
<body>
    <div class="container">
        ...
        <h3 style="color:red">This process is invertible. So be carefull!.</h3>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4    col-sm-6">
            <div class="thumbnail" style="margin-left: 32%;">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                enctype="multipart/form-data">
                <input type="submit" value="Delete Forever" name="btn" class="btn btn-danger">
            </form>
            </div>
        </div>
    </div>
...
<?php }}
if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['btn'] == 'Delete Forever' )
{
    ...
    {
        $_SESSION['notify'] = "Item has been delted Successfully !.";
