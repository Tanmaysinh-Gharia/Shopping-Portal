                ...
                <div class="row">
                    <div class="col-xs-6 col-xs-offset-3">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <form method="post" action="login_submit.php">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                                    </div>
                                    <div class="form-group">
                                        <label for="password" >Password</label>
                                        <input id= "passoword" type="password" class="form-control" name="password" placeholder="Password(min. 6 characters)" pattern=".{6,}">
                                    </div>
                                    <div class="col-xs-6 form-group">
                                        <label for="captcha" >Captcha</label>
                                        <input id="captcha" type="text" class="form-control" name="captcha" placeholder="All alphabets are in uppercase" pattern=".{6,}">                                        
                            ...
                            <div class="panel-footer" style="font-size: 15px;">Don't have an account yet? <a href="signup.php">Register</a></div>
                        </div>
                    </div>
                </div>
           </div>
